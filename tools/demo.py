...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='cfgs/kitti_models/pointpillar.yaml',
                        help='specify the config for demo')
    parser.add_argument('--data_path', type=str, default='/media/xrd/本地磁盘/data/points',
                        help='specify the point cloud data file or directory')

    # '../output/kitti_models/VPfusionRCNN_kitti/default/ckpt/softmax_55_4096.pth'
    parser.add_argument('--ckpt', type=str,
                        default='../output/kitti_models/pointpillar_7728.pth',
...
def main():
    ...
    with torch.no_grad():
        ...
        for idx, data_dict in enumerate(demo_dataset):
            ...
            V.draw_scenes(
                 points=data_dict['raw_points'].squeeze(0)[:, :3],vis = vis,root_path=args.data_path,
